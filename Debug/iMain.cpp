...
void DrawCircle()
{
	...
	j++;
	if (j % 50 == 0){
		if ((circlex >= recx0 && circlex <= recx0 + 36 && (circley == recy[0] + 14 || circley == recy[0] + 12)) || (circlex >= recx1 && circlex <= recx1 + 36 && (circley == recy[1] + 12 || circley == recy[1] + 14)) || (circlex >= recx2 && circlex <= recx2 + 36 && (circley == recy[2] + 12 || circley == recy[2] + 14)) || (circlex >= recx3 && circlex <= recx3 + 36 && (circley == recy[3] + 14 || circley == recy[3] + 12)) || (circlex >= recx4 && circlex <= recx4 + 36 && (circley == recy[4] + 14 || circley == recy[4] + 12)) || (circlex >= recx5 && circlex <= recx5 + 36 && (circley == recy[5] + 14 || circley == recy[5] + 12)) || (circlex >= recx6 && circlex <= recx6 + 36 && (circley == recy[6] + 14 || circley == recy[6] + 12)) || (circlex >= recx7 && circlex <= recx7 + 36 && (circley == recy[7] + 14 || circley == recy[7] + 12)) || (circlex >= recx8 && circlex <= recx8 + 36 && (circley == recy[8] + 14 || circley == recy[8] + 12)) || (circlex >= recx9 && circlex <= recx9 + 36 && (circley == recy[9] + 14 || circley == recy[9] + 12))) circley += 2;
		else circley -= 2;
	}
	if (circley >= 400){
